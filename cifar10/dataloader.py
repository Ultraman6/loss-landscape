...
def get_data_loaders(args):
    ...
    trainset = torchvision.datasets.CIFAR10(root='E:\data\cifar10', train=True, download=True,
                                            transform=transform_train)
    testset = torchvision.datasets.CIFAR10(root='E:\data\cifar10', train=False, download=True,
